...
// Theme definitions matching the original CSS
...
const THEME_STORAGE_KEY = 'hannaui_theme';
const availableThemes: ThemeType[] = ['dark', 'blue', 'purple', 'pink', 'cute'];
